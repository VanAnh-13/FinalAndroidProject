...
public class InputValidationHandler {
    ...
    public static boolean validateRequired(Context context, TextInputLayout textInputLayout, 
        ...
        if (TextUtils.isEmpty(value)) {
            String errorMessage = fieldName + " " + context.getString(R.string.validation_title_required);
    ...
    public static boolean validateNumericRange(Context context, TextInputLayout textInputLayout, 
        ...
        if (TextUtils.isEmpty(value)) {
            textInputLayout.setError(fieldName + " là bắt buộc");
            return false;
        }
        ...
        try {
            ...
            if (numValue < min || numValue > max) {
                textInputLayout.setError(fieldName + " phải từ " + min + " đến " + max);
                return false;
            }
        } catch (NumberFormatException e) {
            textInputLayout.setError("Vui lòng nhập số hợp lệ");
            return false;
        }
    ...
    public static boolean validatePositiveNumber(Context context, TextInputLayout textInputLayout, 
        ...
        try {
            double numValue = Double.parseDouble(value);
            if (numValue <= 0) {
                textInputLayout.setError(fieldName + " phải lớn hơn 0");
                return false;
            }
        } catch (NumberFormatException e) {
            textInputLayout.setError("Vui lòng nhập số hợp lệ");
    ...
    public static boolean validateTextLength(Context context, TextInputLayout textInputLayout, 
        ...
        if (value.length() < minLength) {
            textInputLayout.setError(fieldName + " phải có ít nhất " + minLength + " ký tự");
            return false;
        }
        
        if (value.length() > maxLength) {
            textInputLayout.setError(fieldName + " không được quá " + maxLength + " ký tự");
            return false;
        }
    ...
    public static ValidationResult validateBloodPressure(Context context, 
        ...
        // Validate systolic
        if (!validateNumericRange(context, systolicLayout, 70, 250, "Huyết áp tâm thu")) {
            result.addError("Huyết áp tâm thu không hợp lệ");
        }
        
        // Validate diastolic
        if (!validateNumericRange(context, diastolicLayout, 40, 150, "Huyết áp tâm trương")) {
            result.addError("Huyết áp tâm trương không hợp lệ");
        }
        ...
        if (result.isValid() && systolicLayout.getEditText() != null && 
            ...
            try {
                ...
                if (systolic <= diastolic) {
                    systolicLayout.setError("Huyết áp tâm thu phải lớn hơn tâm trương");
                    result.addError("Huyết áp tâm thu phải lớn hơn tâm trương");
                }
            } catch (NumberFormatException e) {
    ...
    public static boolean validateHeartRate(Context context, TextInputLayout textInputLayout) {
        return validateNumericRange(context, textInputLayout, 30, 220, "Nhịp tim");
    }
    ...
    public static boolean validateBloodSugar(Context context, TextInputLayout textInputLayout) {
        return validateNumericRange(context, textInputLayout, 20, 600, "Đường huyết");
    }
    ...
    public static boolean validateWeight(Context context, TextInputLayout textInputLayout) {
        return validateNumericRange(context, textInputLayout, 10, 500, "Cân nặng");
    }
    ...
    public static boolean validateHeight(Context context, TextInputLayout textInputLayout) {
        return validateNumericRange(context, textInputLayout, 50, 300, "Chiều cao");
    }
    ...
    public static boolean validateReminderTitle(Context context, TextInputLayout textInputLayout) {
        if (!validateRequired(context, textInputLayout, "Tiêu đề")) {
            return false;
        }
        
        return validateTextLength(context, textInputLayout, 2, 100, "Tiêu đề");
    }
    ...
    public static boolean validateReminderDescription(Context context, TextInputLayout textInputLayout) {
        ...
        if (!TextUtils.isEmpty(value) && value.length() > 500) {
            textInputLayout.setError("Mô tả không được quá 500 ký tự");
            return false;
        }
