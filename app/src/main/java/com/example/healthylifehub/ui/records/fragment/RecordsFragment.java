...
/**
 * Fragment for displaying medical records Shows a list of medical records with options to add,
 * edit, and delete
 */
  ...
  public void setOnClick() {
    getBinding()
        ...
        .setOnClickListener(
            v -> {
              if (getActivity()
                  instanceof com.example.healthylifehub.utils.navigation.DrawerController) {
                ((com.example.healthylifehub.utils.navigation.DrawerController) getActivity())
                    .openDrawer();
              }
            });
        ...
        .setOnClickListener(
            v -> {
              Intent intent =
                  new Intent(
                      requireContext(),
                      com.example.healthylifehub.ui.records.add_edit.AddEditRecordActivity.class);
